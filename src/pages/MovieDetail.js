...
export const MovieDetail = () => {
    ...
    useEffect(() => {
        const fetchMovie = async () => {
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=e97b5be27544e99801103a609ef426b6`);
            ...
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                    ...
                    <p className="my-4">
                        ...
                        <a href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreffer">
                            {movie.imdb_id}
                        </a>
                    </p>
